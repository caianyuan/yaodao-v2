    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                half3 ambient = half4(unity_SHAr.w, unity_SHAg.w, unity_SHAb.w, 1) * albedo;
                //diffuse
                ...
                half3 diffuse = albedo * ramp * mainLight.color;
                ...
                return half4(clamp(ambient + diffuse, 0.0, 1.0), 1.0);
            }
            ENDHLSL
        }
    }
